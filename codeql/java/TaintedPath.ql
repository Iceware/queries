/**
 * @name Uncontrolled data used in path expression plus
 ...
 */
/*
* added support for spring resources
* added taint propagation for method access
* CVE found:
* cve-2020-5405
*/
import java
...
class TaintedPathConfig extends TaintTracking::Configuration {
  ...
  override predicate isAdditionalTaintStep(Node n1, Node n2) { methodResult(n1, n2) }
}
